...
def pixel_to_latlon_k40t_thermal(
    ...
    print(
        f"Target UTM: ({target_utm[0]:.2f}, {target_utm[1]:.2f}, {ground_elevation_m:.2f})"
    )
    print(f"Horizontal distance: {distance_m:.2f} m")
    print(
        f"Ray direction (world): [{ray_world[0]:.3f}, {ray_world[1]:.3f}, {ray_world[2]:.3f}]"
    )
